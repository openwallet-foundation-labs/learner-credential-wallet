  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={styles.settingsContainer}>
        ...
        <SettingsItem key="dark-mode" title="Dark mode" onPress={toggleTheme} rightComponent={themeSwitch} />
        <SettingsItem key="manage-profiles" title="Manage profiles" onPress={() => navigation.navigate('ManageProfilesScreen')} />
        <SettingsItem key="register-wallet" title="Register wallet" onPress={registerWallet} />
        <SettingsItem key="restore-wallet" title="Restore wallet" onPress={() => navigation.navigate('RestoreWalletScreen')} />
        <SettingsItem key="backup-wallet" title="Backup wallet" onPress={() => setBackupModalOpen(true)} />
        <SettingsItem key="reset-wallet" title="Reset wallet" onPress={() => setResetModalOpen(true)} />
        <SettingsItem key="about" title="About" onPress={() => navigation.navigate('About')} />
        <SettingsItem key="sign-out" title="Sign out" onPress={lockWallet} />
      </ScrollView>
      <ConfirmModal
        open={resetModalOpen}
