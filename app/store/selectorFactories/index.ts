...
export type SelectorFactoryReturn<F extends UnknownSelectorFactory> =
  ReturnType<ReturnType<F>>
export type SelectorFactoryProps<F extends UnknownSelectorFactory> = Parameters<
  ReturnType<F>
>[1]
export type SelectorFactoryCallbackReturn<F extends UnknownSelectorFactory> = (
  props: SelectorFactoryProps<F>
) => SelectorFactoryReturn<F>
...
export function selectWithFactory<F extends UnknownSelectorFactory>(
  selectorFactory: F,
  props: SelectorFactoryProps<F>
): SelectorFactoryReturn<F> {
