...
export default function DeveloperScreen({
  navigation
}: DeveloperScreenProps): React.ReactElement {
  ...
  function receiveCredentialThroughDeepLink() {
    Linking.openURL(
      'dccrequest://request?issuer=https%3A%2F%2Fissuer.example.com&vc_request_url=https://verify.dcconsortium.org/request/credential&challenge=ke12345678-0001&auth_type=bearer'
    )
  }

  function startShareRequest() {
    Linking.openURL(
      'dccrequest://present?client_id=did%3Akey%3Az6MkpLDL3RoAoMRTwTgo3rs39ZwssfaPKtGdZw7AGRN7CK4W&nonce=123456&redirect_uri=https%3A%2F%2Fexample.com'
    )
  }
        ...
        {WAS.enabled && (
          <>
            <Button
              {...buttonStyleProps}
              title={
                hasWasConnection ? 'W.A.S. Connection' : 'Connect to W.A.S'
              }
              onPress={goWas}
            />
          </>
