...
describe('useAsyncValue', () => {
  ...
  it('should return initial value and loading state', () => {
    ...
    mockUseAsyncValue.mockReturnValue([initialValue, { loading: true, error: undefined }]);
  ...
  it('should return resolved value when async function completes', () => {
    ...
    mockUseAsyncValue.mockReturnValue([expectedValue, { loading: false, error: undefined }]);
  ...
  it('should return error when async function rejects', () => {
    ...
    mockUseAsyncValue.mockReturnValue([undefined, { loading: false, error: expectedError }]);
  ...
  it('should handle undefined initial value', () => {
    ...
    mockUseAsyncValue.mockReturnValue([undefined, { loading: true, error: undefined }]);
