...
jest.mock('../app/store/slices/credentialFoyer', () => ({
  ...
  acceptPendingCredentials: jest.fn(() => ({ type: 'acceptPendingCredentials' })),
...
describe('ApprovalControls', () => {
  ...
  describe('Pending status', () => {
    it('should render Accept and Decline buttons for pending credentials', () => {
      const pendingCredential = new PendingCredential(mockCredential, ApprovalStatus.Pending);
  ...
  describe('Completed status', () => {
    it('should render status icon and message for accepted credentials', () => {
      const pendingCredential = new PendingCredential(mockCredential, ApprovalStatus.Accepted);
      const { getByText } = renderComponent(pendingCredential);
    ...
    it('should render status icon and message for rejected credentials', () => {
      const pendingCredential = new PendingCredential(mockCredential, ApprovalStatus.Rejected);
      const { getByText } = renderComponent(pendingCredential);
    ...
    it('should render status icon and message for errored credentials', () => {
      const pendingCredential = new PendingCredential(mockCredential, ApprovalStatus.Errored);
      const { getByText } = renderComponent(pendingCredential);
